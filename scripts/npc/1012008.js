    ...
    if (status == 0) {
        ...
        if (selection == 2) {
            ...
            if (cm.haveItem(4030012, 15)) {
                ...
                cm.sendNext("想制作#b记忆大考验#k?你需要一些#b怪物卡#k,怪物卡几乎可以在这个岛上任何怪物身上掉落.收集15个怪物卡我就可以给你做记忆大考验."); //Lmfao a set of A set xD
                cm.dispose();
            }
        }
        ...
        if (current == 1) {
            cm.sendNextPrev("如果你知道你的背靠墙，你可以请求一个#r重置#k。如果对方接受你的请求，那么你和你的对手最后的招式将被取消。如果你觉得有必要去洗手间，或者休息一段时间，你可以请求一个\");
        } else if (current == 2) {
        ...
        if (current == 1) {
            cm.sendPrev("下一场比赛开始时，落后者将先手。另外，任何人都不允许在比赛中途离开。如果你这样做了，你可能需要请求一个#b暂停或放弃#k（当然，如果你要求放弃，你将输掉比赛。）如果你在游戏中途点击离开并在游戏结束后打离开，你将在游戏结束后立即离开房间。");
        } else if (current == 2) {
