...
function start() {
    ...
    if (cm.isQuestStarted(6330)) {
        if (cm.getEventInstance() != null) {    // missing script for skill test found thanks to Jade™
            ...
            cm.sendNext("恭喜.你通过了我的测试.我会教你 \"Super Transformation\".\r\n\r\n  #s5121003#    #b#q5121003##k");
        }
        ...
        if (cm.getEventInstance() != null) {
            ...
            cm.sendNext("恭喜.你通过了我的测试.我会教你 \"Battleship\".\r\n\r\n  #s5221006#    #b#q5221006##k");
        }
...
function action(mode, type, selection) {
    ...
    if (actionx["1stJob"]) {
        ...
        if (status == 0) {
            ...
            if (job == 510) {
                cm.sendNext("那么从此你就是一个#b拳手了#k. ");
            } else {
                cm.sendNext("那么从此你就是一个#b枪手了#k.");
            }
            ...
            cm.sendNextPrev((job == 510 ? "好好冒险吧" : "他是我的分身,你将会陷入苦战.他会使用你可能都没有见过的技能.秘密通道有时间限制,你必须在时间结束前打败他.祝你好运,希望你能安全带回#b#t4031059##k.") + "需要坚强，但是记住你不能使用你的力量去欺凌弱小，如果你的力量没有用在正道上，你将难以变得更强。当你想要更近一步的时候，可以来找我，我会在这等你");
        }
