...
function start() {
    cm.sendSimple("你听说过叫#b#m110000000##k的海滩吗,在距离#m" + cm.getPlayer().getMapId() + "#很远的地方?如果你愿意付#b" + pay + "金币#k，或者你有#b#t" + ticket + "##k的话，我可以免费带你去那.\r\n\r\n#L0##b我愿意付" + pay + " 金币.#k#l\r\n#L1##b我有 #t" + ticket + "##k#l\r\n#L2##b什么是 #t" + ticket + "#?#k#l");
}
    ...
    if (mode == -1 || (mode == 0 && status == 0)) {
        ...
        if (status == 1) {
            if (selection == 0 || selection == 1) {
                ...
                cm.sendYesNo(msg + "好的!!小心那边有很多怪物，不要毫无防备的被怪物抓住哦。确认现在出发去#m110000000#吗?");
            } else if (selection == 2) {
            ...
            if (check == 0) {
                if (cm.getMeso() < pay) {
                    cm.sendOk("我想你缺钱. 有很多赚钱的方法..打怪..做任务..卖装备..都可以");
                    cm.dispose();
                } else {
                    cm.gainMeso(-pay);
                    access = true;
                ...
                if (!cm.haveItem(ticket)) {
                    cm.sendOk("#b#t" + ticket + "##k在哪??你确定你有？");
                    cm.dispose();
                } else {
                    access = true;
                }
