        ...
        if (status == 0) {
            ...
            if (state == 3) {
                ...
                if (selection == 0) {
                    ...
                    cm.sendOk("#e#b<组队挑战:刷Boss>#k#n\r\n各地的勇敢冒险者来到这里，寻找更强大的冒险岛首领们测试他们在战斗中的技能和能力。你可以选择独享这份荣誉或者与别人一起组队挑战。奖励会在远征结束的时候发放，奖励的内容取决于你们能走多远，并且队伍中的随机一人会获得一份额外奖励..\r\n\r\n这个挑战支持多个等级范围的玩家一起参与，如果你组了一些等级更低的队友，你能够快速击败首领的可能就会增加不少");
                    cm.dispose();
                }
            }
        }
