...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L3##e#d#v1432012#枫叶枪制作#l\r\n"//3
            text += "#L4##e#d#v1442024#枫叶矛制作#l\r\n"//3
            text += "#L5##e#d#v1412011#枫叶斧制作#l\r\n"//3
            text += "#L6##e#d#v1382012#枫叶杖制作#l\r\n"//3
            text += "#L7##e#d#v1452022#枫叶弓制作#l\r\n"//3
            text += "#L8##e#d#v1462019#枫叶弩制作#l\r\n"//3
            text += "#L9##e#d#v1472032#枫叶拳制作#l\r\n"//3
            text += "#L10##e#d#v1482020#枫叶指节制作#l\r\n"//3
            text += "#L11##e#d#v1492020#枫叶短枪制作#l\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
