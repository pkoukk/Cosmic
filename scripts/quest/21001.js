...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.sendAcceptDecline("*嘤嘤嘤*我好害怕,请带我去找赫丽娜.");
    } else if (status == 1) {
...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendNextPrev("我们没有时间浪费。黑法师的部队越来越近了！如果我们不马上离开，我们就完蛋了！", 9);
    } else if (status == 4) {
        ...
        qm.sendNextPrev("赫丽娜，你为什么不先去金银岛？我答应你，我以后会来找你。我不会有事的，我要和其他英雄一起对抗黑魔法师！", 3);
    } else if (status == 8) {
        qm.gainItem(4001271, -1);
