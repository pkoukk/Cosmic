...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                item = "#z4011007#";
                cm.sendYesNo("要制作一个#z4011007#?你需要:\r\n#i4011000# #i4011001# #i4011002# #i4011003# #i4011004# #i4011005# #i4011006# 各一个\r\n另外我需要收取10000金币的手续费.");
            } else if (selection == 1) {
                item = "#z4021009#";
                cm.sendYesNo("要制作一个#z402100#?你需要:\r\n#4021000# #4021001# #4021002# #4021003# #4021004# #4021005# #4021006#  #4021007#  #4021008# 各一个\r\n另外我需要收取10000金币的手续费.");
            } else if (selection == 2) {
                item = "#z4031042#";
                cm.sendYesNo("要制作一个#z4031042#?你需要:\r\n#4001006# #4011007# #4020008# 各一个\r\n另外我需要收取10000金币的手续费.");
            }
        } else if (status == 3) {
            if (selected == 0) {
                if (cm.haveItem(4011000) && cm.haveItem(4011001) && cm.haveItem(4011002) && cm.haveItem(4011003) && cm.haveItem(4011004) && cm.haveItem(4011005) && cm.haveItem(4011006) && cm.getMeso() >= 10000) {
                    ...
                    cm.sendNext("好了,这是给你的" + item + "。它做的不错因为我用了最好的材料，如果你在路上还需要帮助，随时回来找我");
                } else {
