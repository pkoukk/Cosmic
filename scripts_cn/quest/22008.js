...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (mode == 0) {//decline
            qm.sendNext("我滴个妈呀... 你害怕 #o9300385#? 别告诉任何人你和我有关系。太丢人了.");
            qm.dispose();
        } else {
            qm.forceStartQuest();
...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendNextPrev("#b这是魔术师使用的武器。这是一根魔杖，你可能并不需要它，但如果你随身携带它，它会让你看起来很厉害。哈哈哈哈.");
    } else if (status == 13) {
