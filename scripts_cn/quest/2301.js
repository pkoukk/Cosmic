    ...
    if (mode == -1) {
        ...
        if (mode == 0 && type > 0) {
            ...
            if (status == 0) {
                ...
                qm.sendNext("我不知道确切的细节，但很明显发生了可怕的事情，所以我认为如果你亲自去那里评估损失会更好。像你这样的探险家应该完全有能力拯救蘑菇王国。我刚刚给你写了一封#b推荐信#k，所以我建议你立即前往蘑菇王国，寻找#b首席巡逻官#k。\r\n\r\n#fUI/UIWindow.iimg/QuestIcon/4/0#\r\n#v4032375##t4032375#");
            } else if (status == 3) {
