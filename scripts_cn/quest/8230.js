...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendOk("事情是这样的：扭曲的大师们，目前掌握着焰红深林堡垒的伟大人物，已经计划了对新叶城的大规模进攻，这可能会在未来几天发生。我不能在他们准备进攻的时候呆在这里观察。不过，我不能就这样离开这个位置，我必须不惜一切代价关注他们的动向。你可以进去了：去找卢肯，他曾经是焰红深林堡垒的骑士，他现在在树林里徘徊，接受他进一步的命令，他知道该怎么做.");
        qm.forceStartQuest();
    } else if (status == 2) {
        qm.dispose();
    }
