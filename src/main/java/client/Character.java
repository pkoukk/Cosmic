...
public class Character extends AbstractCharacterObject {
    ...
    public static boolean canCreateChar(String name) {
        ...
        if (name.getBytes(CharsetConstants.CHARSET).length > 12) {
            return false;
        }
        return Pattern.compile("[a-zA-Z0-9\\p{script=Han}]{3,12}").matcher(name).matches();
    }
    ...
    private void levelUpMessages() {
        ...
        if (level == 5) {
            ...
            yellowMessage(
                    "Did you know? The majority of people who hit level 85 in Cosmic don't live to be 85 years old?");
        } else if (level == 90) {
            yellowMessage(
